...
# second image
        ...
        img1=Image.open(r"img\iStock-182059956_18390_t12.jpg")
...
###################  left label frame  ###################3
        ...
        img_left=Image.open(r"img\face-recognition.png")
...
#################### RollNO ########################################
        ...
        rollno_entry=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_roll,font=("times new roman",13,"bold"))
